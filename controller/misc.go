	...
	content := message.EmailTemplate(
		...
		fmt.Sprintf(`
			...
			<p style="text-align: center; margin: 30px 0;">
				<a href="%s" style="background-color: #2e8fb0; color: #ffffff; padding: 12px 28px; text-decoration: none; border-radius: 8px; display: inline-block; font-weight: bold;">Reset password</a>
			</p>
