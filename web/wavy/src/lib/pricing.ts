 ...
 * backend defaults — so "valid" here means finite and >= 0.
 */
...
/** Parse a user-typed ratio/price; null unless finite and >= 0. */
 ...
 * Null when the text is not a JSON object of finite numbers >= 0.
 */
